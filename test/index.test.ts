 ...
 * under the License.
 */
import { PluginChartHelloWorldChartPlugin } from '../src';
 ...
 */
describe('@superset-ui/plugin-chart-plugin-chart-hello-world', () => {
  it('exists', () => {
    expect(PluginChartHelloWorldChartPlugin).toBeDefined();
  });
});
